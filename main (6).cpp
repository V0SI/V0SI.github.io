...
int main()
{
    ...
    cout << "select from onr of the following cryptocurruncies" << endl;
    ...
    // validate the input of money 
    while(money < 0)
    {
        // display an ERROR
        cout << endl <<"ERROR: INVALID AMOUNT OF MONEY ENTERED. TRY AGAIN." << endl;
        cout << endl << "Enter and amount of money (enter at least $0.00): $";
        cin >> money;
    } 
